...
seed_value = variables['seed_value']


# domain layering and size
s_z = variables['s_z']
aq_z = variables['aq_z']
cb_z = variables['cb_z']
...
# middle layer layering and size
...
# middle layer interfaces with sediment and conductive basement
...
DFN.params['domainSize']['value'] = [midlayer_size_x, midlayer_size_y, midlayer_size_z]
...
DFN.add_user_fract(shape=shap_int,
                   ...
                   normal_vector=norm_vec_int_bot,
                   permeability=mat_perm_middle,
                   aspect_ratio=asp_rat_int)

DFN.add_user_fract(shape=shap_int,
                   radii=rad_int,
                   translation=trans_int_top,
                   normal_vector=norm_vec_int_top,
                   permeability=mat_perm_middle,
                   aspect_ratio=asp_rat_int)
#
## Add one family in layer #1
#if fracs in ("small", "both"):
...
# END OF CODE, nothign below is run!
