...
* INPUT
* -----
read / avs / octree_mesh.inp / full_mesh
...
connect
dump / avs / seafloor_surf.inp / mo_surf0
...
dump / avs / sbi_surf.inp / mo_surf1
...
dump / avs / botaq_surf.inp / mo_surf2
...
cmo / setatt / -def- / imt / 1 0 0 / 1
connect
dump / avs / botbox_surf.inp / mo_surf3
#
...
region / r3_base / le s2 

region / r1_sed / gt s0 and le s1
region / r2_aq / gt s1 and le s2
region / r3_base / gt s2 and le s3
...
dump / avs / zoned_mesh.inp / full_mesh

dump / fehm / mesh / full_mesh
finish
"""
with open("assign_zones.lgi", "w") as fp:
    fp.write(lagrit_script)
    
subprocess.call('lagrit < assign_zones.lgi', shell = True)
